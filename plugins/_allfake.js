...
handler.all = async function (m) {
   ...
   global.pu = pp
	...
	global.kontak2 = [
	[owner[0], await conn.getName(owner[0] + '6283846677065@s.whatsapp.net'), 'ᴅᴇᴠᴇʟᴏᴩᴇʀ ʙᴏᴛ', 'segengelek@gmail.com', true],
	[owner[1], await conn.getName(owner[1] + '@s.whatsapp.net'), 'ᴅᴇᴠᴇʟᴏᴩᴇʀ ʙᴏᴛ', 'segengelek@gmail.com', true], ]
